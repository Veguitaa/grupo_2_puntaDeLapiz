const btns = document.querySelectorAll('.btn__tienda ');
const storeProducts = document.querySelectorAll('.store-product__tienda ');
...
// SEARCH FILTER
const search = document.getElementById("search");
const productName = document.querySelectorAll(".product-details__tienda  h2");
